...
Detects when the page is running inside an OBS browser source by checking the User-Agent string, and applies a CSS class accordingly before first paint.
